window.onload = readTextFile("FavoriteOverwatchHeroes/json/data.json", function(text){
...
function buildPage(data_array)
{
    ...
    for (let i = 0; i < data_array.length; i++)
    {
        ...
        {
            var role_image_url = "FavoriteOverwatchHeroes/img/dd-icon.png";
        }
        else if (data_array[i].role == "support") 
        {
            var role_image_url = "FavoriteOverwatchHeroes/img/support-icon.png";
        }
        else if (data_array[i].role == "tank") 
        {
            var role_image_url = "FavoriteOverwatchHeroes/img/tank-icon.png";
        }
        console.log(i);
